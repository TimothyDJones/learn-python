# python_tkinter_calculator.py
# https://www.youtube.com/watch?v=LfbrhSi8itc
...
def CreateWidgets():
    ...
    B_MOD = Button(root, text="%", bd=5, font=("arial", 20, "bold"), width=4, height=2, command=lambda : buttonClick('%'))
    B_MOD.grid(row=1, column=2, padx=5, pady=5)
